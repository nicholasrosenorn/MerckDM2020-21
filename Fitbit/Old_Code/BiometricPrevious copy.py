...
# opens website 
server.browser_authorize('mdw@purdue.edu', 'Merck2020')
...
today = str((datetime.datetime.now() - datetime.timedelta(8)).strftime("%Y-%m-%d"))
...
biometricDF.to_csv("./user_BiometricTest.csv" )
#biometricDF.to_csv('/class/datamine/data/corporate/merck/0352t06fm97rcpc58vpjpruo5ahh8803/Biometric_Data/' + today + '.csv')
