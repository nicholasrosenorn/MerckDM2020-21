...
def Generate_Fake(folder_name, fake_name_list, real_name_list, real_folder_name):
    ...
    for name in name_list:
        ...
        value_list = []
        csv_file = open(r'C:\Users\duslg\Desktop\Fall 2020\Merck\export-2020-07-30 - received (1)\export-2020-07-30 - received\{}\{}.steps.csv'.format(real_folder_name, read_from), 'r')
        ...
        fake_data = []
        with open(r'C:\Users\duslg\Desktop\Fall 2020\Merck\export-2020-07-30 - received (1)\export-2020-07-30 - received\{}\{}.steps.csv'.format(real_folder_name, read_from), 'r') as csv_file:
            csv_reader = csv.DictReader(csv_file)
            with open(r'C:\Users\duslg\Desktop\Fall 2020\Merck\export-2020-07-30 - received (1)\export-2020-07-30 - received\{}\{}.steps.csv'.format(folder_name, fake_name), 'w', newline='') as new_file:
